...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Tue Sep 13 13:07:55 2011
# Project:  genome_skittle.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile genome_skittle.pro
#############################################################################
...
Makefile: genome_skittle.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -o Makefile genome_skittle.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/genome_skittle1.0.0/ && $(COPY_FILE) --parents Color.h colortable.h Interpreter.h Manipulator.h PointRenderer.h Reader.h Renderer.h Sequence.h TextureRenderer.h .tmp/genome_skittle1.0.0/ && $(COPY_FILE) --parents Color.cpp colortable.cpp ErroringFacility.cpp genome_skittle.cpp Interpreter.cpp Manipulator.cpp PointRenderer.cpp Reader.cpp Renderer.cpp Sequence.cpp TextureRenderer.cpp .tmp/genome_skittle1.0.0/ && (cd `dirname .tmp/genome_skittle1.0.0` && $(TAR) genome_skittle1.0.0.tar genome_skittle1.0.0 && $(COMPRESS) genome_skittle1.0.0.tar) && $(MOVE) `dirname .tmp/genome_skittle1.0.0`/genome_skittle1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/genome_skittle1.0.0
