...
# Generated by qmake (2.01a) (Qt 4.6.2) on: Fri Aug 26 19:47:56 2011
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/genome_skittle1.0.0/ && $(COPY_FILE) --parents Color.h Interpreter.h Manipulator.h Reader.h Renderer.h Sequence.h .tmp/genome_skittle1.0.0/ && $(COPY_FILE) --parents Color.cpp ErroringFacility.cpp genome_skittle.cpp Interpreter.cpp Manipulator.cpp Reader.cpp Renderer.cpp Sequence.cpp .tmp/genome_skittle1.0.0/ && (cd `dirname .tmp/genome_skittle1.0.0` && $(TAR) genome_skittle1.0.0.tar genome_skittle1.0.0 && $(COMPRESS) genome_skittle1.0.0.tar) && $(MOVE) `dirname .tmp/genome_skittle1.0.0`/genome_skittle1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/genome_skittle1.0.0
