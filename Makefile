...
# Generated by qmake (2.01a) (Qt 4.7.2) on: Fri Aug 26 18:48:54 2011
# Project:  genome_skittle.pro
# Template: app
# Command: /usr/bin/qmake -spec /usr/share/qt4/mkspecs/linux-g++ QMLJSDEBUGGER_PATH=/usr/share/qtcreator/qml/qmljsdebugger -o Makefile genome_skittle.pro
#############################################################################
...
Makefile: genome_skittle.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
	...
	$(QMAKE) -spec /usr/share/qt4/mkspecs/linux-g++ QMLJSDEBUGGER_PATH=/usr/share/qtcreator/qml/qmljsdebugger -o Makefile genome_skittle.pro
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/genome_skittle1.0.0/ && $(COPY_FILE) --parents Color.h Manipulator.h Reader.h Renderer.h Sequence.h .tmp/genome_skittle1.0.0/ && $(COPY_FILE) --parents Color.cpp ErroringFacility.cpp genome_skittle.cpp Manipulator.cpp Reader.cpp Renderer.cpp Sequence.cpp .tmp/genome_skittle1.0.0/ && (cd `dirname .tmp/genome_skittle1.0.0` && $(TAR) genome_skittle1.0.0.tar genome_skittle1.0.0 && $(COMPRESS) genome_skittle1.0.0.tar) && $(MOVE) `dirname .tmp/genome_skittle1.0.0`/genome_skittle1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/genome_skittle1.0.0
